<template>
<article id="app">
    <h1 @click="pascal = !pascal">
      &lt;{{ pascal ? 'VueClamp' : 'vue-clamp' }}&gt;
    </h1>
    <div id="lang" class="lang btn-group">
      <button class="btn btn-sm" :class="{ active: !zh }" @click="zh = false">
        English
      </button>
      <button class="btn btn-sm" :class="{ active: zh }" @click="zh = true">
        中文
      </button>
    </div>
    <p>
      ...
      <div class="form-horizontal">
        <div class="form-group">
          ...
          <div
            ...
            :data-tooltip="
              zh ? '任意 CSS 长度值' : 'Any valid CSS length value'
            "
          >
    ...
    <section class="case">
      ...
      <p class="mt-2">
        {{
          zh
            ? '截断状态：' + (clamped3 ? '已截断' : '未截断')
            : 'Clamped: ' + (clamped3 ? 'Yes' : 'No')
        }}
      </p>
    </section>
    ...
    <section class="case">
      <div class="form-horizontal">
        <div class="form-group">
          <label class="form-label col-5 col-sm-12">{{
            zh ? '位置' : 'Location'
          }}</label>
    ...
    <div
      class="divider text-center"
      :data-content="zh ? '↓ 安装' : '↓ Installation'"
    />
    <pre
      class="code shell"
      data-lang="Shell"
    ><code>$ npm i --save vue-clamp</code></pre>
    <div
      class="divider text-center"
...
&lt;/script&gt;
        ...
        <li>
          ...
          <p>
            <span
              ...
              :data-tooltip="
                zh ? '支持 .sync 修饰符' : 'Supports .sync modifier'
              "
              >.sync</span
            >
          </p>
          ...
          <section class="secondary">
            ...
            <p>
              ...
              {{
                zh
                  ? '切换被截断文本的展开状态。'
                  : 'Toggle the expand state of clamped text.'
              }}
            </p>
            <p>
              ...
              {{
                zh
                  ? '内容是否处于截断状态。'
                  : 'Whether text content is being clamped.'
              }}
            </p>
            <p>
              <code>expanded: Boolean</code>
              ...
              {{
                zh
                  ? '内容是否处于展开状态。'
                  : 'Whether text content is being expanded.'
              }}
            </p>
          </section>
          <p>
    ...
    <section>
      <ul>
        <li>
          ...
          <p>
            {{
              zh ? '截断状态变化时触发。' : 'Emitted when clamp state changes.'
            }}
          </p>
          <p>
            {{ parameterText }}
    ...
    <footer>
      <p v-if="zh">
        ...
        和<a href="https://github.com/Justineo/vue-clamp/graphs/contributors"
          >贡献者们</a
        >共同创作。
      </p>
      <p v-else>
        ...
        <a href="https://github.com/Justineo">@Justineo</a>
        and
        <a href="https://github.com/Justineo/vue-clamp/graphs/contributors"
          >contributors</a
        >.
      </p>
      <p>
...
<script lang="ts">
import VClamp from './components/vue-clamp.vue'
import qs from 'qs'
import hljs from 'highlight.js'
import javascript from 'highlight.js/lib/languages/javascript'
import diff from 'highlight.js/lib/languages/diff'
import shell from 'highlight.js/lib/languages/shell'
import vue from './vue-lang'
